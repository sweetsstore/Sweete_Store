...
<div>
    ...
    <div id="good">
        <div id="pic">
            <img alt="" src="./img/shangpin.png">
        </div>
        <div id="word">发表对该商品的评价</div>
    </div>
    <div id="mid">
        <textarea wrap="soft" cols="50" rows="6" required maxlength="300" placeholder="随便说点什么吧" style="width: 100%;height: 10.71rem"></textarea>
        <div class="container">
            <div class="feedback">
              <div class="rating">
                ...
                <div class="emoji-wrapper">
                  <div class="emoji">
                    <svg class="rating-0" viewBox="0 0 512 512">
                    ...
                    <svg class="rating-1"  viewBox="0 0 512 512">
                      <circle cx="256" cy="256" r="256" fill="#ffd93b"/>
                    ...
                    <svg class="rating-2"  viewBox="0 0 512 512">
                      <circle cx="256" cy="256" r="256" fill="#ffd93b"/>
                      <path d="M512 256A256 256 0 0 1 56.7 416.7a256 256 0 0 0 360-360c58.1 47 95.3 118.8 95.3 199.3z" fill="#f4c534"/>
                    ...
                    <svg class="rating-3" viewBox="0 0 512 512">
                      <circle cx="256" cy="256" r="256" fill="#ffd93b"/>
                    ...
                    <svg class="rating-4"  viewBox="0 0 512 512">
                      <circle cx="256" cy="256" r="256" fill="#ffd93b"/>
                      <path d="M512 256A256 256 0 0 1 56.7 416.7a256 256 0 0 0 360-360c58.1 47 95.3 118.8 95.3 199.3z" fill="#f4c534"/>
